...
logger = logging.getLogger("a_share.quotes")
    ...
    def get_kline(self, symbols, period="day", count=100):
        ...
        for sym in symbols:
            ...
            try:
                ...
                logger.warning("Tencent kline failed for %s: %s", sym, e)
                results[sym] = []
...
class MootdxQuotes:
    ...
    def get_quotes(self, symbols):
        try:
            ...
            logger.warning("Mootdx quotes failed: %s", e)
            raise
